  ...
  return (
    <div>
        ...
        <form className="form-inline my-1">
      {
        ...
        <NavLink activeStyle={activeStyle} className="btn btn-outline-white btn-md mr-5 shadow  rounded" to="/chat" >Chat</NavLink>
        <NavLink activeStyle={activeStyle} className="btn btn-outline-white btn-md mr-5 shadow  rounded" to="/join" >Join</NavLink>
              </>
  ) : (
                <>
          ...
          <NavLink activeStyle={activeStyle} className="btn btn-outline-white btn-md mr-5 shadow  rounded" to="/signup" >Signup</NavLink>
          <NavLink activeStyle={activeStyle} className="btn btn-outline-white btn-md mr-5 shadow rounded" to="/" exact>Login</NavLink>
                </>
        )
    }
        </form> 
